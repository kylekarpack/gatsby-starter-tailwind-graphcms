...
subtitle: 'Caring for rivers.<br />Compassion for people.'
images: 
  - 
    description: Ringer Loop Road - Ellensburg, WA
    url: ../images/slider/main.jpg
  -
    description: Tolt River - King County, WA
    url: ../images/slider/tolt.jpg
  - 
    description: Norma Creek - Snohomish County, WA
    url: ../images/slider/slider_work.jpg
  - 
    description: Lower Canyon Creek - Whatcom County, WA
    url: ../images/slider/canyon.jpg
  - 
    description: Swift Creek - Whatcom County, WA
    url: ../images/slider/swift.jpg
meta:
...
<a
  className="inline-block px-6 py-4 text-md font-medium leading-6 text-center text-white uppercase transition bg-primary rounded shadow ripple hover:shadow-lg hover:bg-primary-500 focus:outline-none"
  href="/contact">
