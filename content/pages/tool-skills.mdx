...
import { StaticImage as Img } from "../../src/components/StaticImage";
...
<div className="Image-inline">
	<img src="http://watershedse.com/wp-content/uploads/2012/09/modeling-212x280.png" />
</div>
...
<div className="Image-inline">
	<Img height={100} src="careers_colin.jpg" alt="Colin in the field" />
</div>
